...
module.exports = (data, fileName, appendToFile) => {
    ...
    CATALOG_CUSTOM_FIELD_467;CATALOG_CUSTOM_FIELD_468;CATALOG_CUSTOM_FIELD_469;CATALOG_CUSTOM_FIELD_470;CATALOG_CUSTOM_FIELD_471;CATALOG_CUSTOM_FIELD_472;`.replace(/[\n\t\s]+/g, '') + '\n';
